...
public class ShowReturned extends JPanel{
    Image mBackroundmg;
    ...
    public ShowReturned(JFrame mFrame,String netID,String hostID,String mStudentRFID,int mTransactionID){
       setLayout(null); 
       ...
       mStudentImageFile=new File(mEllewRetriveStudentDetailFromDatabase.getStudentImageLocation());
       mBookImageFile=new File(mEllewRetriveBookDetailFromDatabase.getBookCoverImagLocation());
       mBookImageIcon=new ImageIcon(mBookImageFile.getAbsolutePath());
       mStudentImageIcon=new ImageIcon(mStudentImageFile.getAbsolutePath());
       ...
       jbConfirm.addActionListener(new ActionListener(){
           ...
           public void actionPerformed(ActionEvent e) {
               ...
               mEllewBookBrowserIntoDatabase.RemoveBookBorrowerIntoDatabase(netID,hostID, mStudentID);
               new EllewUpdateState(mTransactionID);
               JOptionPane.showConfirmDialog(mFrame,"The Book is successfully returned.","Issued",JOptionPane.PLAIN_MESSAGE);
               mFrame.dispose();
           }
       });
    ...
    ImageIcon iconBackground=new ImageIcon(getClass().getResource("/img/image-5.jpg"));
        ...
        g.drawString("sure about this return?",screenSize.width/2-250,250);
